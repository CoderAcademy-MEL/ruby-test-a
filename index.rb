...
#a name given to an object in ruby

# Question 2: What Ruby method can you use to make a loop from an array?
#def loop_method(array)
  #array.each do |array_item|
  #end
#end

# Question 3: In Ruby, what are the booleans?
#responses to code that are either true or false 

# Question 4: 
# a. In Ruby what is coercion? Explain what coercion is using the code snippet below.
#coercion is the changing of one datatype to another. It can be done either implicitly or explicitly.
#In the below example, it's explicitly coercing a nil value to a string based on a conditional if statement.
# if nil 
#   puts "hi"
# end 

# Question 5: What is a class? 
#Class is an object that the developer has created. I can have its own attributes, methods and variables 

# Question 6: What is an instance variable?
#a variable (name given to an object) that relates specifically to one instance (creation) of a class 

# Question 7: What is handy about using gems in Ruby?
#It's code already written that completes something that you need. It prevents a double up on work
...
student = {name: "string" age: 0}

# Question 16: Write a Ruby method that takes three arguments and returns the sum (total) of those three arguments.
# def sum_total(arg1, arg2, arg3)
#   total = arg1 + arg2 + arg3
# end 

# Question 17: Write a Ruby method that takes an array and a string as arguments, 
#and returns true if the string is in the array, and false if it is not. 
#Use a loop in this method. You can use .each but you CANNOT use .include?
# alphabet = ["a", "b", "c"]

# def question17(array, query)
#   array.each do |letter| 
#   p letter == query
#   end
# end 

# question17(alphabet, "c")
...
# Question 19: You must use your previous method in this next question. 
#Write another method that takes an array (of numbers) as an argument. 
#This method will use your first method to return two arrays (within one array - an array of arrays) 
